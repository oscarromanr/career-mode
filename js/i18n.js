...
(function (root) {
  ...
  const UI_EN = {
    ...
    'card.freeAgentTitle': 'Free Agent',
    'tier.bronze': 'BRONZE',
    'tier.silver': 'SILVER',
    'tier.gold': 'GOLD',
    'tier.diamond': 'ICON',
    ...
    'note.contractExpired': 'Contract with {club} expired! Entering Free Agency.',
    ...
    'offerNote.loanBuyout': 'BUYOUT OFFER — The loan club has offered a permanent deal for you.',
    ...
    'agent.withdrawMove': '📋 Withdraw Transfer Request',
    'agent.clubSituation': 'Club Situation',
    'agent.sitListed': 'Transfer Listed',
    'agent.sitLoan': 'Available for Loan',
    'agent.sitNotForSale': 'Not on Sale',
    'agent.transferWithdrawn': 'Withdrew transfer request. You are no longer transfer listed.',
    'agent.errNotFound': 'Agent not found',
    'agent.errAlreadyActive': 'Already your active agent',
    'agent.errToggled': 'Already toggled transfer status this season',
    'agent.errNotListed': 'You are not currently transfer listed',
    'agent.errRaiseDemanded': 'Already demanded a wage raise this season',
    'agent.errCutNegotiated': 'Already negotiated transfer cut this season',
    'agent.errUnrealisticCut': 'Agent {name} deemed a {pct}% cut unrealistic',
    'shop.errAlreadyRerolled': 'Already rerolled shop this season',
    'shop.errNoFunds': 'Not enough career earnings',
    'shop.errMaxPurchases': 'Max shop purchases reached ({max} for {tier} tier)',
    'shop.errUnknownItem': 'Unknown item',
    ...
    'nat.btn': 'Awesome!',
    'nat.multipleNationalitiesTitle': 'Multiple Nationalities',
  ...
  const UI_ES = {
    ...
    'card.freeAgentTitle': 'Agente Libre',
    'tier.bronze': 'BRONCE',
    'tier.silver': 'PLATA',
    'tier.gold': 'ORO',
    'tier.diamond': 'ÍCONO',
    ...
    'note.contractExpired': '¡Contrato con {club} finalizado! Quedaste Libre.',
    ...
    'agent.withdrawMove': '📋 Retirar Solicitud de Transferencia',
    'agent.clubSituation': 'Situación en el Club',
    'agent.sitListed': 'Transferible',
    'agent.sitLoan': 'Disponible para Préstamo',
    'agent.sitNotForSale': 'Intransferible',
    'agent.transferWithdrawn': 'Retiraste la solicitud. Ya no estás transferible.',
    'agent.errNotFound': 'Agente no encontrado',
    'agent.errAlreadyActive': 'Ya es tu agente activo',
    'agent.errToggled': 'Ya cambiaste tu estado de transferencia esta temporada',
    'agent.errNotListed': 'Actualmente no estás en la lista de transferencias',
    'agent.errRaiseDemanded': 'Ya exigiste un aumento de sueldo esta temporada',
    'agent.errCutNegotiated': 'Ya negociaste el recorte de transferencia esta temporada',
    'agent.errUnrealisticCut': 'El agente {name} consideró poco realista un recorte del {pct}%',
    'shop.errAlreadyRerolled': 'Ya actualizaste la tienda esta temporada',
    'shop.errNoFunds': 'No tienes suficientes ganancias en tu carrera',
    'shop.errMaxPurchases': 'Alcanzaste el límite de compras de la tienda ({max} para el nivel {tier})',
    'shop.errUnknownItem': 'Artículo desconocido',
    ...
    'nat.btn': '¡Excelente!',
    'nat.multipleNationalitiesTitle': 'Nacionalidades Múltiples',
