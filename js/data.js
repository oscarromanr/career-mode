...
(function (root) {
  ...
  /* ----------------------------------------------------------
     ...
     ---------------------------------------------------------- */
  const DECISIONS = []; // decisions moved to js/data-decisions-canonical.js (Stage 6)
  const BOOSTERS = [
    // Field - bronze
  ...
  // Decisions moved to the canonical pack (Stage 6). Node callers must load
  // js/data-decisions-canonical.js; the browser loads it right after this file.
  root.GAME_DATA = DATA;
  if (typeof require !== 'undefined' && typeof module !== 'undefined' && module.exports) module.exports = DATA;
